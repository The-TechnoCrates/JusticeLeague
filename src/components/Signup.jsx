export default function () {
  return (
	...
	<div
		...
		<div>
			<h1 className="text-white font-bold text-4xl font-sans">Justice League</h1>
			<p className="text-white mt-1">Connect with Top Legal Service Providers in India!</p>
	...
	<div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form className="bg-white">
			...
			<p className="text-sm font-normal text-gray-600 mb-7">Hello Again!</p>
				...
				<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<div className="flex items-center border-2 py-2 px-3 rounded-2xl">
							...
							<span className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Or Continue</span>
